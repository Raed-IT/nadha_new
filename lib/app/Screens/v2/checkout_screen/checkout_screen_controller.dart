...
class CheckoutScreenController extends GetxController with ApiHelperMixin {
  void placeOrder(BuildContext context)async {
    if (Get.find<MainController>().selectedAddress.value==null){
      ToastService.showErrorToast(
        context: context,
        title: 'الرجاء اختيار موقع الطلب',
      );
      return ;
    }
