...
class CheckoutScreen extends GetView<CheckoutScreenController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          AppBarWithTitleComponent(title: "الدفع"),
          40.verticalSpace,
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      RadioWithLabelComponent(value: 1,groupValue: 1, label: "عند الاستلام",onChanged: (d){},),
                ...
                Padding(
                  padding: EdgeInsets.all(20.sp),
                  child: PrimaryButtonComponent(label: "إرسال الطلب"),
                )
              ],
            ),
          ),
